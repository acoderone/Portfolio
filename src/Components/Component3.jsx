function Component3() {
  return (
    <div className=" flex flex-col gap-10 justify-center py-10 ">
      ...
      <div className="flex flex-col gap-12  border-2 py-5  rounded-md">
        <div className="flex flex-col items-center">
          <div className="heading1 ">My Tech Stack</div>
          <div>Technologies I have been working with recently</div>
        </div>

        <div className="flex flex-wrap gap-10 md:flex justify-center">
          <img className="hover:scale-110 hover:translate-y-3 transition easy-in-out duration-200" width={"90px"} src="https://www.vectorlogo.zone/logos/w3_html5/w3_html5-icon.svg" />
          <img className="hover:scale-110 hover:translate-y-3 transition easy-in-out duration-200" width={"90px"} src="https://www.vectorlogo.zone/logos/w3_css/w3_css-icon.svg" />
          <img className="hover:scale-110 hover:translate-y-3 transition easy-in-out duration-200" width={"90px"} src="https://upload.vectorlogo.zone/logos/javascript/images/806c2e30-cf85-4b36-81bb-037049603c34.svg" />
          <img className="hover:scale-110 hover:translate-y-3 transition easy-in-out duration-200"  width={"90px"}  src="https://www.vectorlogo.zone/logos/reactjs/reactjs-icon.svg" />
          <img className="hover:scale-110 hover:translate-y-3 transition easy-in-out duration-200"  width={"90px"} src="https://www.vectorlogo.zone/logos/mongodb/mongodb-icon.svg" />
          <img className="hover:scale-110 hover:translate-y-3 transition easy-in-out duration-200"  width={"90px"} src="https://www.vectorlogo.zone/logos/nodejs/nodejs-icon.svg" />
          <img className="hover:scale-110 hover:translate-y-3 transition easy-in-out duration-200"  width={"90px"} src="https://www.vectorlogo.zone/logos/typescriptlang/typescriptlang-icon.svg" />
          <img className="hover:scale-110 hover:translate-y-3 transition easy-in-out duration-200"  width={"90px"} src="https://www.vectorlogo.zone/logos/postgresql/postgresql-icon.svg" />
          <img className="hover:scale-110 hover:translate-y-3 transition easy-in-out duration-200" width={"90px"}  src="https://raw.githubusercontent.com/devicons/devicon/master/icons/prisma/prisma-original.svg" />
